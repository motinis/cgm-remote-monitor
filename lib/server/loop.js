...
function init (env, ctx) {
  ...
  loop.sendNotification = function sendNotification (data, remoteAddress, completion) {
    ...
    if (data.eventType === 'Temporary Override Cancel') {
      ...
      if (data.autoBolusCarbsActive !== undefined) {
        payload["override-update-auto-bolus-carbs-active"] = true
        payload["override-auto-bolus-carbs-active"] = data.autoBolusCarbsActive
      }
